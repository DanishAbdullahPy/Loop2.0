...
import {
  ...
  setDoc,
  where,
} from "firebase/firestore"; // Firebase functions to interact with the database
  ...
  const CreateNewDocument = async () => {
    ...
    if (documentList?.length >= MAX_FILE) {
      toast("Upgrade to add new file", {
        description:
          "You reached the max file limit. Please upgrade for unlimited file creation.",
        action: {
          label: "Upgrade",
  ...
  return (
    <div className="fixed hidden h-screen p-5 shadow-md md:w-72 md:block bg-blue-50">
      ...
      <div className="absolute bottom-10 w-[85%]">
        ...
        <h2 className="my-2 text-sm font-light">
